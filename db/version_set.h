...
//           in sorted order.
    ...
    public:
        ...
        // Return a human readable string that describes this version's Empty Guard Information.
        std::string EmptyGuardsInfo() const;
    ...
    public:
        ...
        */
        ...
        Status
        LogAndApply(VersionEdit *edit, port::Mutex *mu, port::CondVar *cv, bool *wt, std::vector<uint64_t> file_numbers,
                    std::vector<std::string *> file_level_fitlers, int mtc)
        ...
        // To pick the required compaction object to compact the guard files
        // in a level and assign them to proper guards
        Compaction *PickCompactionForGuards(Version *v, unsigned level,
